...
class CNN(object):
    ...
    def _build_network(self, input_tensor, is_training):
        ...
        net = ConvRelu(net, 32, (3, 3), 'conv_conv1')
        ...
        net = ConvRelu(net, 128, (3, 3), 'conv_conv4')
        ...
        net = ConvReluBN(net, 1024, (3, 3), 'conv_conv9', is_training)
        net = ConvRelu(net, 1024, (3, 3), 'conv_conv10')
        net = max_2x1pool(net, 'conv_pool6')

        net = ConvReluBN(net, 2048, (3, 3), 'conv_conv11', is_training)
        net = ConvRelu(net, 2048, (3, 3), 'conv_conv12')
        net = max_2x1pool(net, 'conv_pool7')

        net = ConvReluBN(net, 2048, (2, 2), 'conv_conv13', is_training, "VALID")
